...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = Faze.getX();
		int robotYLocation = Faze.getY();
		
		// 6. Print the robotXLocation and robotYLocation variables to the console 
		System.out.println(robotYLocation+ " " +robotXLocation);
		...
		{
		JOptionPane.showMessageDialog(null, "The thing you are looking for is surounded in a tight dark space");
		JOptionPane.showMessageDialog(null, "The thing you are looking for is under you, deep down");
		}
		...
		if( robotXLocation== 460 &&robotYLocation== 260) {
